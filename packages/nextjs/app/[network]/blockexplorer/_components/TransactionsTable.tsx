                    ...
                    <td className="w-2/12 md:py-4">
                      <Address
                        ...
                        blockExplorerAddressLink={
                          targetNetwork.id === hardhat.id ? networkHref(`/blockexplorer/address/${tx.from}`) : undefined
                        }
                      />
                    </td>
                    <td className="w-2/12 md:py-4">
                      {!receipt?.contractAddress ? (
                          ...
                          <Address
                            ...
                            blockExplorerAddressLink={
                              targetNetwork.id === hardhat.id
                                ? networkHref(`/blockexplorer/address/${tx.to}`)
                                : undefined
                            }
                          />
                        )
                        ...
                        <div className="relative">
                          <Address
                            ...
                            blockExplorerAddressLink={
                              targetNetwork.id === hardhat.id
                                ? networkHref(`/blockexplorer/address/${receipt.contractAddress}`)
                                : undefined
                            }
                          />
