...
const OwnedOrgCard = ({
  ...
  return <OwnedOrgCardLink orgAddress={orgAddress} name={name} programCount={programCount} />;
};

const OwnedOrgCardLink = ({
  orgAddress,
  name,
  programCount,
}: {
  ...
  programCount: bigint | undefined;
}) => {
  const networkHref = useNetworkHref();
  return (
    <Link
      href={networkHref(`/organization/${orgAddress}`)}
      ...
      {!connectedAddress ? (
        <div className="mt-8 flex flex-col gap-8">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <Link
              href={networkHref("/organizations")}
            ...
            <section>
              ...
              {visiblePrograms.size === 0 && (
                <p className="text-sm opacity-70">
                  ...
                  <Link href={networkHref("/programs")} className="link link-primary">
